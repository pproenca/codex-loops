{application,iex,
             [{modules,['Elixir.IEx','Elixir.IEx.App',
                        ...
                        'Elixir.IEx.Info.Date','Elixir.IEx.Info.DateTime',
                        ...
                        'Elixir.IEx.Info.Range','Elixir.IEx.Info.Reference',
                        'Elixir.IEx.Info.Regex','Elixir.IEx.Info.Time',
                        'Elixir.IEx.Info.Tuple','Elixir.IEx.Introspection',
                        'Elixir.IEx.MixListener','Elixir.IEx.Pry',
                        'Elixir.IEx.Server']},
